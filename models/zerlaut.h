...
float P0, float P1, float P2, float P3, float P4, float P5, float P6, float P7, float P8, float P9, float E_l) {
	...
	*////////
	...
	float fout = estimate_firing_rate(mu_V, sigma_V, T_V, V_thre);

//    if (t<10 && id==0)
//        printf("t %d mv %f sv %f tv %f vthre %f fout %f\n", t, mu_V, sigma_V, T_V, V_thre, fout);
